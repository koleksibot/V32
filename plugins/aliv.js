...
if (Config.WORKTYPE == 'private') {
    ...
    QueenSew.newcmdaddtosew({pattern: 'alive', fromMe: true, desc: Lang.PR}, (async (message, match) => {
    ...
    QueenSew.newcmdaddtosew({pattern: 'alive', fromMe: false, desc: Lang.PR}, (async (message, match) => {

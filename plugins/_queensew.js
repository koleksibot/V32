...
QueenSew.newcmdaddtosew({pattern: 'thilina ?(.*)', fromMe: false, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        QueenSew.commands.map(
            async (command) =>  {

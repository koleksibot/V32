...
const HID = "यह एक प्लगइन के साथ सुखद उपकरण अंदर है। (Meme Pack V3)"
    ...
    if (ch.WORKTYPE === 'private') {
        ...
        QueenSew.newcmdaddtosew({pattern: 'n7', fromMe: true, dontAdCommandList: true}, (async (message, match) => {

            await message.sendMessage("\n♪ღ♪*•.¸¸.•*¨¨*•.♪ღ♪*•.¸¸.•*¨¨*•.♪ღ♪\n░H░A░P░P░Y░♪░B░I░R░T░H░D░A░Y░\n♪ღ♪*•.¸¸.•*¨¨*•.♪ღ♪*•.¸¸.•*¨¨*•.♪ღ♪");

        }));

        QueenSew.newcmdaddtosew({pattern: 'n8', fromMe: true, dontAdCommandList: true}, (async (message, match) => {

            await message.sendMessage("\n_/﹋\_\n(҂`_´)\n<,︻╦╤─ ҉ - -\n_/﹋\_");

        }));

        QueenSew.newcmdaddtosew({pattern: 'n9', fromMe: true, dontAdCommandList: true}, (async (message, match) => {

...
async function sewQueen () {
    ...
    setInterval(async () => { 
        ...
        while (getGMTh == 18 && getGMTm == 00) {
            var ilan = ''
            if (Raviya.LANG == 'EN') ilan = '| *✨Daily Announcements For Public-Bot✨* |\n\n'
            if (Raviya.LANG == 'SI') ilan = '| *✨Public-Bot වට්සැප් බොට් සදහා දෛනික නිවේදන✨* |\n\n'
    ...
    setInterval(async () => { 
        ...
        while (getGMTq == 08 && getGMTs == 00) {
            var srmg = ''
            if (Raviya.LANG == 'EN') srmg = '| *✨Daily Announcements For Public-Bot✨* |\n\n'
            if (Raviya.LANG == 'SI') srmg = '| *✨Public-Bot වට්සැප් බොට් සදහා දෛනික නිවේදන✨* |\n\n'
...
${chalk.blue.italic('🇱🇰 Try To Login WhatsApp... Please Wait...')}`);
    ...
    CdSew.on('credentials-updated', async () => {
        ...
        console.log(chalk.bgGreen('🤖 Public-Bot is' + rssewqueengg + ' 🤖'));
                        ...
                        try {
                            ...
                            if (Raviya.LANG == 'SI') {
                                if (error.message.includes('URL')) {
                                    return await CdSew.sendMessage(CdSew.user.jid, '*🧟‍♂️ දෝෂ විශ්ලේෂණය [Public-Bot] 🧟‍♀️*' + 
                                        '\n========== ```දෝෂ නිරාකරණය කර ඇත!``` ==========' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await CdSew.sendMessage(CdSew.user.jid, '*🧟‍♂️ ERROR ANALYSIS [Public-Bot] 🧟‍♀️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
